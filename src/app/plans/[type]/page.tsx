            ...
            <Card padding="sm" className="space-y-3">
              ...
              {exercises.length === 0 ? (
                ...
                <div className="space-y-3">
                  {exercises.map((ex) => (
                    <div key={ex.exerciseId} className="bg-slate-50 rounded-2xl p-3 space-y-3">
                      <div className="flex items-center justify-between">
                        <div>
                        ...
                        <button
                          ...
                          className="text-red-400 w-8 h-8 flex items-center justify-center
                                     rounded-lg bg-red-50 active:scale-90 transition-all"
                        >
                          ✕
                        </button>
                      </div>
                      ...
                      <div className="space-y-2">
                        {/* Reps row */}
                        <div className="flex items-center justify-between">
                          <span className="text-xs text-slate-500 w-12">סטים</span>
                          <div className="flex items-center gap-2">
                            <button
                              onClick={() => updateField(ex.exerciseId, "sets", Math.max(1, ex.sets - 1))}
                              className="w-8 h-8 bg-white rounded-lg border border-slate-200 text-sm font-bold active:scale-90 transition-all"
                            >−</button>
                        ...
                        <div className="flex items-center justify-between">
                          <span className="text-xs text-slate-500 w-12">חזרות</span>
                          <div className="flex items-center gap-2">
                            <button
        ...
        <div className="fixed inset-0 z-50 flex flex-col bg-white">
          <div className="flex items-center justify-between p-4 border-b border-slate-100">
            <div>
              ...
              <p className="text-xs text-slate-400">{workoutInfo.labelHe}</p>
            </div>
            <button
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          added
                            ? "bg-primary-50 border-primary/20 opacity-60"
